...
class AtsCompanyRemoteJobReport(BaseModel):
    # ats name
    rootsitename: Optional[str] = None
    ...
    # dict of companies with remote jobs
    companieswithremotejobs: Optional[Dict[str, int]]
    # dict of companies with jobs to investigate for remote
    companieswithjobstoinvestigateforremote: Optional[Dict[str, int]]
